...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0003_announcementdistribution'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='session',
            name='classroom',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='classroom_session', to='home.Classroom'),
        ),
        migrations.AddField(
            model_name='session',
            name='date',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classroom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='classroom_resource', to='home.Classroom')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='session_resource', to='home.Session')),
            ],
        ),
    ]
