...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=salesforce.fields.CharField(blank=True, max_length=20, null=True, verbose_name='Jigsaw Contact ID'),
        ),
        migrations.AddField(
            model_name='contact',
            name='last_activity_date',
            field=salesforce.fields.DateField(blank=True, null=True, verbose_name='Last Activity'),
        ),
        migrations.AddField(
            model_name='contact',
            name='last_curequest_date',
            field=salesforce.fields.DateTimeField(blank=True, db_column='LastCURequestDate', null=True, verbose_name='Last Stay-in-Touch Request Date'),
        ),
        migrations.AddField(
            model_name='contact',
            name='last_cuupdate_date',
            field=salesforce.fields.DateTimeField(blank=True, db_column='LastCUUpdateDate', null=True, verbose_name='Last Stay-in-Touch Save Date'),
        ),
        migrations.AddField(
            model_name='contact',
        ...
        migrations.AddField(
            model_name='contact',
            name='photo_url',
            field=salesforce.fields.URLField(blank=True, null=True, verbose_name='Photo URL'),
        ),
        migrations.AddField(
            model_name='contact',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='individual_owner_set', to='home.User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_short_name', salesforce.fields.CharField(blank=True, db_column='Course_short_name__c', max_length=1300, null=True, verbose_name='Course short name')),
                ...
                ('created_by', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='classoffering_createdby_set', to='home.User')),
                ('instructor', salesforce.fields.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='home.Contact')),
                ('last_modified_by', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='classoffering_lastmodifiedby_set', to='home.User')),
                ('location', salesforce.fields.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='home.Account')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='classenrollment_contact_set', to='home.Contact')),
                ('created_by', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='classenrollment_createdby_set', to='home.User')),
                ('last_modified_by', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='classenrollment_lastmodifiedby_set', to='home.User')),
                ('parent_contact', salesforce.fields.ForeignKey(blank=True, db_column='Parent_Contact__c', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='classenrollment_parentcontact_set', to='home.Contact')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='contact',
            name='created_by',
            field=salesforce.fields.ForeignKey(default=django.utils.timezone.now, on_delete=django.db.models.deletion.DO_NOTHING, related_name='contact_createdby_set', to='home.User'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='contact',
        ...
        migrations.AddField(
            ...
            field=salesforce.fields.ForeignKey(default='Tyler Iams', on_delete=django.db.models.deletion.DO_NOTHING, related_name='contact_lastmodifiedby_set', to='home.User'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='contact',
            name='owner',
            field=salesforce.fields.ForeignKey(blank=True, default=django.utils.timezone.now, on_delete=django.db.models.deletion.DO_NOTHING, related_name='contact_owner_set', to='home.User'),
            preserve_default=False,
        ),
    ]
