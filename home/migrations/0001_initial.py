    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        default="No Description Available", max_length=2000
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "salesforce_id",
                    models.CharField(default="xxxxxx19010101", max_length=14),
                ),
                (
                    "user",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="notified_about_form",
                        to="home.Form",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="form_to_be_signed",
                        to="home.Form",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    salesforce.fields.EmailField(blank=True, max_length=254, null=True),
                ),
                (
                    "title",
                    salesforce.fields.CharField(blank=True, max_length=128, null=True),
                ),
                (
                    "department",
                    salesforce.fields.CharField(blank=True, max_length=80, null=True),
                ...
                (
                    ...
                    salesforce.fields.CharField(blank=True, max_length=255, null=True),
                ),
                (
                    "email_bounced_date",
                    salesforce.fields.DateTimeField(blank=True, null=True),
                ...
                (
                    "enrollments_this_semester_applied",
                ...
                (
                    "enrollments_this_semester_waitlisted",
                    salesforce.fields.DecimalField(
                        blank=True,
                ...
                (
                    "enrollments_this_semester_rejected",
                    salesforce.fields.DecimalField(
                        blank=True,
                ...
                (
                    "enrollments_this_semester_drop_out",
                    salesforce.fields.DecimalField(
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "recipient_classrooms",
                    models.ManyToManyField(
                        related_name="recipient_classroom", to="home.Classroom"
                    ),
                ),
                (
                    "recipient_groups",
