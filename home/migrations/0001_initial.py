# Generated by Django 2.2.3 on 2019-07-30 02:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendance_summary', django.contrib.postgres.fields.jsonb.JSONField(default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, related_name='esign_creator_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Form',
            fields=[
                ...
                ('esign', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='esign_form', to='home.Esign')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification', models.TextField(max_length=2500)),
                ('email_recipients', models.BooleanField(default=False)),
                ('notified', models.DateTimeField(auto_now=True, db_index=True)),
                ('acknowledged', models.BooleanField(default=False)),
                ('attendance', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='notified_about_attendance', to='home.Attendance')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notification_user', to=settings.AUTH_USER_MODEL)),
                ('form', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='notified_about_form', to='home.Form')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='contact_createdby_set', to='home.User')),
                ('individual', salesforce.fields.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='home.Individual')),
                ('last_modified_by', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='contact_lastmodifiedby_set', to='home.User')),
                ...
                ('npsp_primary_affiliation', salesforce.fields.ForeignKey(blank=True, db_column='npsp__Primary_Affiliation__c', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='contact_npspprimaryaffiliation_set', to='home.Account')),
                ('owner', salesforce.fields.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='contact_owner_set', to='home.User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient_classrooms', models.ManyToManyField(related_name='recipient_classroom', to='home.Classroom')),
